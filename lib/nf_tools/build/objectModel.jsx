...
NFComp = (function(superClass) {
  ...
  NFComp.prototype.createHighlight = function(model) {
    ...
    model = {
      ...
      rectHash: (ref4 = model.rectHash) != null ? ref4 : null
    };
    ...
    for (i = j = 1, ref5 = model.lines; 1 <= ref5 ? j <= ref5 : j >= ref5; i = 1 <= ref5 ? ++j : --j) {
  ...
  NFComp.prototype.addTextLayer = function(model) {
    var index, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, textAVLayer, textDoc, textDocProp, tooManyIndices;
    if (model.time == null) {
    ...
    model = {
      ...
      tracking: (ref11 = model.tracking) != null ? ref11 : 0
    };
...
NFLayer = (function(superClass) {
  ...
  /**
  Slides in or out the layer using markers. #slideIn and #slideOut both
  call this method
  @memberof NFLayer
  @returns {NFLayer} self
  @param {Object} [model] - The options
  @param {enum} [model.fromEdge=NFComp.AUTO] - The direction to slide in from.
  Default if layer is centered is the right.
  @param {boolean} [model.in=yes] - If layer should slide in. No means out
  @param {float} [model.length=2] - duration of the slide
   */

  NFLayer.prototype.slide = function(model) {
    var animatingX, animatingY, compCenter, endEquation, endValue, layerCenter, positionProperty, ref, slider, startEquation, startOffset, startValue, xVal, yVal, zVal;
    if (model == null) {
      model = [];
    }
    ...
    slider = (ref = this.effects().property("Start Offset")) != null ? ref : this.addSlider("Start Offset", startOffset);
    xVal = (function() {
      switch (false) {
        case !animatingX:
  ...
  /**
  Slides in the layer using markers.
  @memberof NFLayer
  @returns {NFLayer} self
  @param {Object} [model] - The options
  @param {enum} [model.fromEdge=NFComp.AUTO] - The direction to slide in from.
  ...
  NFLayer.prototype.slideIn = function(model) {
    return this.slide({
      "in": true,
  ...
  /**
  Slides out the layer using markers.
  @memberof NFLayer
  @returns {NFLayer} self
  @param {Object} [model] - The options
  ...
  NFLayer.prototype.slideOut = function(model) {
    return this.slide({
      "in": false,
...
NFLayerCollection = (function(superClass) {
  ...
  NFLayerCollection.prototype.sortByIndex = function() {
    var i, j, orderedLayers, ref, topLayer;
    if (this.isEmpty()) {
      return this;
    }
    if (!this.inSameComp()) {
      throw new Error("Can't sort if layers are from multiple comps");
    }
    orderedLayers = [];
    for (i = j = 0, ref = this.count() - 1; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
...
NFCitationLayer = Object.assign(NFCitationLayer, {
  ...
  newLooseCitationLayer: function(name, containingComp, time) {
    var citationComp, citeLayer, compName, invertProp, sourceExpression;
...
NFGaussyLayer = Object.assign(NFGaussyLayer, {
  ...
  newGaussyLayer: function(model) {
    ...
    model = {
      layer: (function() {
        if ((ref = model.layer) != null) {
          return ref;
        } else {
          throw new Error("Gaussy layers need a target layer");
        }
      })(),
      time: (ref1 = model.time) != null ? ref1 : model.layer.containingComp().getTime(),
...
NFHighlightLayer = (function(superClass) {
  ...
  NFHighlightLayer.prototype.changeLineCount = function(delta) {
    var currentLineCount, group, highlightLines, highlighterEffect, i, j, k, l, lineGroup, linePathProp, lineShape, lineStrokeProp, lineTrimProp, newLineCount, ref, ref1, ref2;
    highlighterEffect = this.highlighterEffect();
    if (this.property("Contents").property("Highlight Lines") != null) {
      highlightLines = this.property("Contents").property("Highlight Lines").property("Contents");
      ...
      for (i = j = ref = currentLineCount; ref <= 1 ? j <= 1 : j >= 1; i = ref <= 1 ? ++j : --j) {
        highlightLines.property(i).remove();
      }
    } else {
      currentLineCount = this.property("Contents").numProperties;
      lineShape = this.property("Contents").property(currentLineCount).property("Contents").property("Path 1").property("Path").value;
      for (i = k = ref1 = currentLineCount; ref1 <= 1 ? k <= 1 : k >= 1; i = ref1 <= 1 ? ++k : --k) {
        this.property("Contents").property(i).remove();
      }
      group = this.property("Contents").addProperty("ADBE Vector Group");
      group.name = "Highlight Lines";
    ...
    if (newLineCount < 1) {
      ...
      for (i = l = 1, ref2 = newLineCount; 1 <= ref2 ? l <= ref2 : l >= ref2; i = 1 <= ref2 ? ++l : --l) {
...
NFHighlightLayer = Object.assign(NFHighlightLayer, {
  ...
  isHighlightLayer: function(theLayer) {
    return theLayer instanceof ShapeLayer && theLayer.Effects.numProperties > 0 && (theLayer.Effects.property("AV_Highlighter") != null);
  },
...
NFPartComp = (function(superClass) {
      ...
      case cmd.END_ELEMENT:
        ...
        for (l = 0, len2 = allTargets.length; l < len2; l++) {
          ...
          if (theTarget["class"] === "NFReferencePageLayer") {
            ...
            results1.push(target.animateOut(model.settings.durations.refTransition));
          } else if (theTarget["class"] === "NFPageLayer") {
            layersToTrim.forEach((function(_this) {
              return function(layer) {
                var flightPaths;
  ...
  NFPartComp.prototype.addGaussy = function(model) {
    var activeGaussy, activeGroup, activePDF, belowTarget, children, gaussy, placeholder, ref1, ref2, ref3;
    if (model == null) {
      model = {};
    }
    model.time = (ref1 = model.time) != null ? ref1 : this.getTime();
    model.duration = (ref2 = model.duration) != null ? ref2 : this.$.duration - model.time;
    activePDF = this.activePDF(model.time);
    if ((activePDF != null) || (model.layer != null)) {
      if (model.layer == null) {
        activeGroup = this.groupFromPDF(activePDF);
      }
      ...
      if (activeGaussy != null) {
        ...
        gaussy = NFGaussyLayer.newGaussyLayer({
          layer: (ref3 = activeGroup != null ? activeGroup.getCitationLayer() : void 0) != null ? ref3 : model.layer,
          time: model.time,
          duration: model.duration
        });
        if (model.layer == null) {
  ...
  NFPartComp.prototype.addBrowserWindow = function(layers) {
    ...
    if (!(layers instanceof NFLayerCollection && layers.count() > 0)) {
      alert("Error adding browser window: invalid layer collection or layer");
    }
    this.$.openInViewer();
    ...
    suffix = layers.count() === 1 ? layers.get(0).getName() : "Multiple Layers";
    ...
    preCompIndexes = [];
    pastedLayers.forEach((function(_this) {
      return function(theLayer, i, allLayers) {
        theLayer.$.startTime = 0;
        if (theLayer.$.canSetCollapseTransformation) {
          return theLayer.$.collapseTransformation = true;
        } else {
          return preCompIndexes.push(theLayer.index());
        }
      };
    })(this));
    for (j = 0, len = preCompIndexes.length; j < len; j++) {
      idx = preCompIndexes[j];
